package com.hfdemo.filesharedemo.ftp.ftpclient;
...
import com.hfdemo.filesharedemo.ftp.ftpclient.UploadFileChooserAdapter.FileInfo;
...
public class FtpClientActivity extends Activity implements OnClickListener {
	...
	private static String TAG = FtpClientActivity.class.getName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ftp_client_activity_main);
		initView();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.ftp_client_activiity_main_menu, menu);
		return true;
	}
